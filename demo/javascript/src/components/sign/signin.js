...
module.exports = React.createClass({
    ...
    login: function () {
        ...
        var username = '4' || (WebIM.config.autoSignIn ? WebIM.config.autoSignInName : '');
        var auth = '123456' || (WebIM.config.autoSignIn ? WebIM.config.autoSignInPwd : '');
        var type = false;
    ...
    signin: function (username, auth, type) {
        ...
        var options = {
            ...
            success: function (token) {
                ...
                WebIM.utils.setCookie('webim_' + encryptUsername, token, 1);//登录信息存到cookie
    ...
    componentDidMount: function () {
        // console.log(WebIM.utils.getCookie()['webim_NA'])
            // this.login();
